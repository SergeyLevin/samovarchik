      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            ...
            >
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden shadow-sm group-hover:shadow-md transition-all border-2 border-primary-100 bg-white flex items-center justify-center">
                <ResponsiveImage
                  name="logo"
                  alt="Самоварчик"
          ...
          <button className="lg:hidden text-secondary-800 p-2" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
