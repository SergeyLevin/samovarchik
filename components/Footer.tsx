    ...
    <footer className="bg-secondary-900 text-secondary-400 py-12 border-t border-secondary-800">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-3 mb-4 text-white">
              <div className="w-10 h-10 rounded-full overflow-hidden border border-secondary-700">
                <img 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a 
                  href="#promotions" 
                  onClick={(e) => handleLinkClick(e, '#promotions')}
                  className="hover:text-primary-500 transition-colors cursor-pointer"
                >
                  Акции
                </a>
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+79126107078" className="hover:text-white transition-colors">+7 (912) 610-70-78</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-secondary-800 flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
          <div>
            &copy; {new Date().getFullYear()} Столовая «Самоварчик». Все права защищены.
          </div>
